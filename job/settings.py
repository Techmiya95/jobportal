...
SECRET_KEY = 'django-insecure-*5c(cf6o3!p$eq0c^41%8-3!@6kdm7m8=_%_&im_*-lzm5+-g4'
...
DATABASES = {
    ...
    'default': {
        ...
        'CLIENT': {
            'host': 'mongodb+srv://jobportal:techmiya@jobportal.qhq2faj.mongodb.net/',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app/static'),  # Ensure it points to your static folder
]
